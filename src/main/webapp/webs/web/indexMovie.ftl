        ...
        <div class="layui-layout layui-layout-admin">
            <div class="layui-header">
                ...
                <ul class="layui-nav layui-layout-left">
                    <li class="layui-nav-item"><a href="webs/web/index.ftl">论坛</a></li>
                ...
                <ul class="layui-nav layui-layout-right">
                    ...
                    <li class="layui-nav-item">
                        <a href="#">
                            <img src="../picture/04e88b25bc315c609782abbb83b1cb1349547762.jpg" class="layui-nav-img"/>
                            我
                        </a>
            ...
            <div class="layui-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">影视</h3>
                    </div>
                    <div class="panel-body">
                        <ul class="list-group">
                            <li class="list-group-item active"><a href="#" class="font-color">我不是药神</a></li>
                            <li class="list-group-item"><a href="#" class="font-color">美丽心灵</a></li>
                            <li class="list-group-item disabled"><a href="#" class="font-color">霸王别姬</a><span class="badge">热门</span></li>
                        </ul>
                    </div>
                </div>
